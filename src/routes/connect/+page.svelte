...
<svelte:head>
	<title>Connect | {cityConfig.name} Comedy Connector</title>
	<meta
		name="description"
		content="Connect with {cityConfig.name}'s comedy community — find book openers, join a team, or hire a coach."
	/>
</svelte:head>
